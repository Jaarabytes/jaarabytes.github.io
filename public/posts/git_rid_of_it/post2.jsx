...
function Post2({darkMode}){
    return(
        ...
        <br></br>
        <Snippet code={`ssh-keygen -t rsa -b 4096 -C "your_email@example.com"`}>
        </Snippet>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet code={` Generating public/private ALGORITHM key pair.`}>
        </Snippet>
        <br></br>
        <br></br>
        <p>
        ...
        <br></br>
        <Snippet code={`ssh -T git@github.com`}></Snippet>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet code={`git remote set-url origin <ssh_github_repo_link>;`}>
        </Snippet>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet code={`sudo apt install gh`} />
        <br></br>
        <br></br>

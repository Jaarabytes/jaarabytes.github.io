...
function Post2({darkMode}){
    return(
        ...
        <br></br>
        <Snippet code={`ssh-keygen -t rsa -b 4096 -C "your_email@example.com"`} language="Bash" darkMode={darkMode}>
        </Snippet>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet code={` Generating public/private ALGORITHM key pair.`} language="Bash"  darkMode={darkMode}>
        </Snippet>
        <br></br>
        <br></br>
        <p>
...
ssh-add ~/.ssh/id_rsa
        ...
        <br></br>
        <Snippet code={`ssh -T git@github.com`} darkMode={darkMode}  language="Bash" ></Snippet>
        <br></br>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet  language="Bash" darkMode={darkMode} code={`git remote set-url origin <ssh_github_repo_link>;`}>
        </Snippet>
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet language="Bash"  darkMode={darkMode} code={`git remote -v`} />
        <br></br>
        <br></br>
        <p>More info here :</p>
        <br></br>
        ...
        <br></br>
        <Snippet  language="Bash" darkMode={darkMode} code={`sudo apt install gh`} />
        <br></br>
        <br></br>
        ...
        <br></br>
        <Snippet  language="Bash" darkMode={darkMode} code={`gh auth login`} />
        <br></br>
        <br></br>
